...
abstract class CleanedPlayer: BasePlayer() {
  ...
  override fun getCurrentTracksInfo() = TracksInfo.EMPTY
  ...
  @Deprecated("Deprecated in Java") override fun getCurrentTrackGroups() = TODO("getCurrentTrackGroups")
  @Deprecated("Deprecated in Java") override fun getCurrentTrackSelections() = TODO("getCurrentTrackGroups")
  ...
  override fun getCurrentCues() = listOf(Cue.EMPTY)
}